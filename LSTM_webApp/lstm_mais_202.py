...
CPI_monthly = pd.read_csv('CPI_data.csv')

# Set the seed for the data shuffling
random.seed(1)
...
# Retain all the data minus the last 20 observations for forecasting
scaled_CPI = scaled_CPI[:960, 0]


# let's transform our remaining data into a uni-variate supervised learning problem
...
# Integrate the model into the pickle file for web showcase
